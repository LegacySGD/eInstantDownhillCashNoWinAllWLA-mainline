...
public class DownhillCashNoWinAllWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DownhillCashNoWinAllWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DownhillCashNoWinAllWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DownhillCashNoWinAllWLAIW/InitOutcome.xml").getDocumentElement();
